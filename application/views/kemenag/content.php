				...
				<div class="main--content col-md-8 col-sm-7" data-sticky-content="true">
					<div class="sticky-content-innebr">
						...
						<div class="col-md-12 ptop--30 pbottom--30">
							...
							<div class="col-md-12 ptop--30 pbottom--30">
								<div class="post--items-title" data-ajax="tab">
									<a href = "<?php echo base_url(); ?>albums"><h2 class="h4">Galeri Foto</h2></a>
									<div class="nav">
									</div>
								</div>
										...
										foreach ($album->result_array() as $row) {
											...
											<div class="post--item post--layout-1">
												<div class="post--img">
													...
													<a href="<?php echo base_url(); ?>albums" class="thumb"><img src="<?php echo base_url()."template/" . template() . "/timthumb.php?src=" . base_url() . "asset/img_album/$row[gbr_album]"?>&amp;w=450&amp;h=300" alt="<?php echo $row['jdl_album']; ?>"></a>
													<div class="post--info">
														<div class="title">
															<h2 class="h4"><a href="<?php echo base_url(); ?>albums" class="btn-link"><?php echo $row['jdl_album'] ?></a></h2>
														</div>
													</div>
												</div>
											</div>
