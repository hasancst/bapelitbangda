          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <?php
				...
				$cek=$this->model_app->umenu_akses("kepalainstansi",$this->session->id_session);
                if($cek==1 OR $this->session->level=='admin'){
                  echo "<li><a href='".base_url()."administrator/kepalainstansi'><i class='fa fa-circle-o'></i> Kepala Instansi</a></li>";
                }
              ?>
              </ul>
            </li>
            ...
            <li class="treeview">
              <a href="#"><i class="glyphicon glyphicon-blackboard"></i> <span>Modul Iklan / Banner</span><i class="fa fa-angle-left pull-right"></i></a>
              <ul class="treeview-menu">
              <?php
                ...
                if($cek==1 OR $this->session->level=='admin'){
                  echo "<li><a href='".base_url()."administrator/banner'><i class='fa fa-circle-o'></i> Link Terkait</a></li>";
                }
              ?>
              </ul>
            </li>
